...
APangaeaGameMode::APangaeaGameMode()
{
	...
	static ConstructorHelpers::FClassFinder<APawn> PlayerPawnBPClass(TEXT("/Game/TopDown/Blueprints/Player/BP_PlayerHead.BP_PlayerHead"));
	...
	static ConstructorHelpers::FClassFinder<APlayerController> PlayerControllerBPClass(TEXT("/Game/TopDown/Blueprints/Player/BP_TopDownPlayerController.BP_TopDownPlayerController"));
